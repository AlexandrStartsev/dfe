defineForm("quote.cmau.car", [ "require", "dfe-common", "dfe-field-helper", "components/div-button", "components/label", "components/button", "components/div", "components/c-radiolist", "components/c-editbox", "components/c-dropdown", "components/editbox-dropdown-switch", "components/c-editbox-$", "components/container", "components/c-checkbox", "components/tab-s" ], function(require, cmn, fields, __c_div_button, __c_label, __c_button, __c_div, __c_c_radiolist, __c_c_editbox, __c_c_dropdown, __c_editbox_dropdown_switch, __c_c_editbox_$, __c_container, __c_c_checkbox, __c_tab_s) {
    return new class {
        ...
        setup() {
           ...
           /*, function() {
    define('components/editbox-dropdown-switch', ['ui/utils', 'components/component', 'components/label','components/editbox', 'components/dropdown'], function(uiUtils, base) {
        return uiUtils.createComponent('editbox-dropdown-switch', base, 
            `<dfe-label data='attrs.html' style='padding-left: 10px'/>
             <dfe-switch data='attrs.component == "editbox" ? data.value : data' errs=''/>`)
    })
    define('components/editbox-dropdown-switch', ['components/labeled-component', 'components/editbox', 'components/dropdown', 'ui/utils'], function(DWC, Editbox, Dropdown, uiUtils) {
        ...
        return _extend({
            ...
            render: function(nodes, control, data, errs, attrs, events) { 
                if(!defer(nodes, control, data, errs, attrs, events)) {
                    ...
                    DWC.render.call(this, nodes, control, attrs.editbox ? data.value : data, errs, attrs, events);
                }
            }
        }, DWC, Editbox.base());
    })
